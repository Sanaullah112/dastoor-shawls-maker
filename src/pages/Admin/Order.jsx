      ...
      <div className="max-w-7xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 pb-5 border-b border-gray-100">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Track incoming purchases, status changes, and invoices</p>
          </div>
          {orders.length > 0 && (
            <button
              onClick={handleClearAll}
              className="bg-red-50 text-red-600 border border-red-200 px-4 py-2 text-sm font-semibold rounded-lg hover:bg-red-100 transition duration-150 shadow-sm"
            >
              Clear All Orders
            </button>
          )}
